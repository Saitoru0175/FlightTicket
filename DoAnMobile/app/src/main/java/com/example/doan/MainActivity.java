...
//        ViewPager2 mViewPager2 = findViewById(R.id.viewPager);
        ...
        listNew.add(new News("Phú Quốc","uudai1"));
        listNew.add(new News("Phú Quốc","uudai2"));
        listNew.add(new News("Phú Quốc","uudai3"));
        listNew.add(new News("Phú Quốc","uudai4"));
        listNew.add(new News("Phú Quốc","uudai5"));
        listNew.add(new News("Phú Quốc","uudai6"));
